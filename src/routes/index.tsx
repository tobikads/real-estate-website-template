  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled ? "bg-[#faf7f2]/95 backdrop-blur-md shadow-[0_1px_0_rgba(0,0,0,0.04)]" : "bg-transparent"
      }`}
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm font-light">
              ...
              <li><a href="#work" className="hover:text-white transition-colors">Start Here</a></li>
            </ul>
          </div>
        </div>
