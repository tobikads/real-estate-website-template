  ...
  head: () => ({
    meta: [
      { title: "Selling a Home | Alexandra Carter" },
      {
        name: "description",
        content:
          "Guidance for home sellers in Atlanta. Alexandra Carter helps you understand your options before making a move.",
      },
    ],
  }),
      ...
      <div className="flex min-h-screen items-center justify-center px-6">
        <div className="text-center max-w-lg">
          ...
          <p className="mt-6 text-stone-600 font-light leading-relaxed">
            We're preparing something thoughtful for home sellers. A clear, calm
            way to understand your options. Check back soon.
          </p>
        </div>
      </div>
    </div>
